...
export const authUser = (fields, role, mode) => async (dispatch) => {
    ...
    try {
        const result = await axios.post(`${backend_URL}${role}${mode}`, fields, {
...
export const addStuff = (address, fields) => async (dispatch) => {
    ...
    try {
        const result = await axios.post(`${backend_URL}${address}`, fields, {
            headers: { 'Content-Type': 'application/json' },
        });
...
export const updateStuff = (fields, id, address) => async (dispatch) => {
    ...
    try {
        const result = await axios.put(`${backend_URL}${address}/${id}`, fields, {
            headers: { 'Content-Type': 'application/json' },
        });
        if (result.data.message) {
...
export const deleteStuff = (id, address) => async (dispatch) => {
    ...
    try {
        const result = await axios.delete(`${backend_URL}${address}/${id}`);
        if (result.data.message) {
...
export const updateCustomer = (fields, id) => async (dispatch) => {
    ...
    try {
        await axios.put(`${backend_URL}CustomerUpdate/${id}`, newFields, {
            headers: { 'Content-Type': 'application/json' },
        });
...
export const getProductsbySeller = (id) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${backend_URL}getSellerProducts/${id}`);
        if (result.data.message) {
...
export const getProducts = () => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${backend_URL}getProducts`);
        if (result.data.message) {
...
export const getProductDetails = (id) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${backend_URL}getProductDetail/${id}`);
        if (result.data.message) {
...
export const getCustomers = (id, address) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${backend_URL}${address}/${id}`);
        if (result.data.message) {
...
export const getSearchedProducts = (address, key) => async (dispatch) => {
    ...
    try {
        const result = await axios.get(`${backend_URL}${address}/${key}`);
        if (result.data.message) {
